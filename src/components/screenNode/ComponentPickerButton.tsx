                ...
                (() => {
                    ...
                    return createPortal(
                        <div
                            ...
                            className="nodrag nopan fixed bg-white border border-gray-200 rounded-xl shadow-2xl p-3 z-[9000] animate-in fade-in zoom-in duration-150 origin-top-left min-w-[200px] max-h-[320px] overflow-y-auto"
                            style={{
                                left: screenPos.x,
                                top: screenPos.y,
                                ...
                                componentList.map((c) => (
                                    <div key={c.id} className="flex-none w-44 flex flex-col gap-2">
                                        <button
                                            ...
                                            className="w-full bg-white p-2 rounded-lg shadow-sm hover:shadow-md transition-colors text-left"
                                            title="전체 추가"
                                        >
