    ...
    return (
        <div className="flex w-full h-screen overflow-hidden bg-gray-50">
            ...
            <div id="erd-canvas-container" className="flex-1 min-w-0 h-full relative select-none pr-4 pt-4 pb-4 pl-4" ref={flowWrapper}>
                ...
                <div
                    ref={erdToolbarRef}
                    className="w-max absolute top-4 left-1/2 z-[10001] bg-white/80 backdrop-blur-md rounded-xl shadow-lg border border-gray-100 p-2 flex flex-nowrap items-center gap-2 transition-all duration-300"
                    style={{
