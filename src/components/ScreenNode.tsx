...
const ScreenNode: React.FC<NodeProps<ScreenNodeData>> = ({ data, selected }) => {
    ...
    return (
        ...
        >
            ...
            <div className={`bg-white rounded-[15px] overflow-hidden shadow-xl border-2 flex flex-col h-full ${selected
                ...
                <div className="flex bg-white min-h-[500px]">
                    ...
                    <div className="w-[70%] flex-shrink-0 border-r border-gray-200 flex flex-col bg-gray-50/10 overflow-hidden">
                    ...
                    <div className="w-[30%] flex-shrink-0 flex flex-col bg-white" style={{ minWidth: 250 }}>
                        {/* Panel 1: 초기화면설정 */}
